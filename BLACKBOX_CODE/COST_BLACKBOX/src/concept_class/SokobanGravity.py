...
class SokobanGravityConceptClass(AbstractConceptClass):
    def __init__(self):
        pass
    ...
    def get_all_concepts_for_state(self, state):
        ...
        for conc in CONCEPT_TO_MODEL_MAP_FOR_GRAVITY:
            if self.run_classifier(CONCEPT_TO_MODEL_MAP_FOR_GRAVITY[conc], state):
