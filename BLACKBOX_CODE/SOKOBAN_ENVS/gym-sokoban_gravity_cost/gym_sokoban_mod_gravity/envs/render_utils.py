...
def room_to_rgb(room, room_structure=None):
    ...
    special_cell_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'special_cell.png')))
    #power_up_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'floor.png')))
    special_cell = imageio.imread(special_cell_filename)

    on_special_cell_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'player_on_cell.png')))
    on_special_cell = imageio.imread(on_special_cell_filename)



    box_on_special_cell_filename = pkg_resources.resource_filename(resource_package, '/'.join(('surface', 'box_on_pink.png')))
    box_on_special_cell = imageio.imread(box_on_special_cell_filename)
