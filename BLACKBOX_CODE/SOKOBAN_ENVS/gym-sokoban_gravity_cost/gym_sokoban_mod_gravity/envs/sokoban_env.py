...
class SokobanEnv(gym.Env):
    ...
    def __init__(self,
        ...
        self.penalty_for_step_large = -10
        self.penalty_box_off_target = -1
        self.reward_box_on_target = 0#000
        self.reward_finished = 0#000
        self.reward_last = 0
    ...
    def _push(self, action):
        ...
        can_push_box = self.room_state[new_position[0], new_position[1]] in [3, 4, 9]
        ...
        if can_push_box:
            ...
            self.room_state[(new_position[0], new_position[1])] = player_type
            ...
            if self.room_fixed[new_box_position[0], new_box_position[1]] == 2:
                box_type = 3
            elif self.room_fixed[new_box_position[0], new_box_position[1]] == 7:
                box_type = 9
    ...
    def _calc_reward(self):
        ...
        if (8 not in self.room_state) or self.current_action >= 5 or self.current_action == 0:
            self.reward_last = self.penalty_for_step
        else:
            self.reward_last = self.penalty_for_step_large
